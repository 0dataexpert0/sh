#!/bin/bash
#
# https://github.com/0dataexpert0
#
# Copyright (c) 2019 0dataexpert0. Released under the MIT License.
...
Use an older version if Ubuntu 16.04 support is needed: https://raw.githubusercontent.com/0dataexpert0/sh/master/openvpn/openvpn-ubuntu16.sh'
	exit
fi
...
LimitNPROC=infinity" > /etc/systemd/system/openvpn-server@server.service.d/disable-limitnproc.conf
	...
	# Get easy-rsa
	easy_rsa_url='https://github.com/0dataexpert0/sh/raw/master/openvpn/EasyRSA-nix-3.0.5.tgz'
